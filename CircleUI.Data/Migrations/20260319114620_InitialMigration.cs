    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebsiteProjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WebsiteProjects_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pages_WebsiteProjects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "WebsiteProjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublishedVersions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PublishedVersions_WebsiteProjects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "WebsiteProjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pages_ProjectId_Path",
                table: "Pages",
                columns: new[] { "ProjectId", "Path" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PublishedVersions_ProjectId",
                table: "PublishedVersions",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_WebsiteProjects_UserId",
